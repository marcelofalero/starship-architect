export const initTutorial = (context = {}) => {
    const COMPLETED_KEY = 'warships_tutorial_completed';
    const PART1_KEY = 'warships_tutorial_part1_completed';
        ...
        steps = [
            {
                popover: {
                    ...
                    description: 'Welcome to the Warships Starship Architect. Let\'s get you started with your first ship.',
                }
            },
            {
