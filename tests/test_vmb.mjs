...
{
    const original = { biome: 12, elevation: 5, moisture: 3, faction: 2, feature: 11 };
...
{
    const maxValues = { biome: 15, elevation: 7, moisture: 7, faction: 3, feature: 15 };
    ...
    const overflowValues = { biome: 16, elevation: 8, moisture: 8, faction: 4, feature: 16 };
    const packedOverflow = packTile(overflowValues);
    const unpackedOverflow = unpackTile(packedOverflow);
    // 16 & 0xF = 0; 8 & 0x7 = 0; 4 & 0x3 = 0
