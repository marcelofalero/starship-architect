...
export const DeckPlanWrapper = {
    ...
    template: `
    <div class="row fit q-pa-md" style="height: calc(100vh - 120px); overflow: hidden;">
        ...
        <div class="col-12 col-md-9" style="height: 100%; overflow: auto; background-color: #000; border: 2px solid #4BB5C1; position: relative;" @mouseleave="onGridMouseUp" @mouseup="onGridMouseUp">
            ...
            <div v-else-if="activeSection" 
                 ...
                 <div v-for="item in activeSection.items" :key="item.id" 
                     ...
                     <span style="position: absolute; top: 0; left: 0; font-size: 8px; color: yellow; background: rgba(0,0,0,0.5); padding: 1px;">z:{{ item.z !== undefined ? item.z : getDefaultZ(item.type) }}</span>
